...
//
//  @GetMapping("/add")
//  public ModelAndView viewAddVehicle(Model model) {
//    return new ModelAndView("add","vehicle",new Vehicle());
//
//    @PostMapping(value = { "/add" })
//    public String addVhc(@ModelAttribute("vehicle") Vehicle vehicle, Model model) {
//
